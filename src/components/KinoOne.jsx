  ...
  return (
    <div className="my-[30px]">
      <div className="card lg:card-side bg-base-100 shadow-xl mb-[10px]">
        <figure>
          <img className="rounded-[20px]" src={kino.image} alt="Album" />
        </figure>
        <div className="card-body">
          <h2 className="card-title mx-auto lg:mx-0">{kino.name}</h2>
          <div className="flex flex-col gap-2 mt-[10px] mx-auto lg:mx-0">
            ...
            <span className="flex flex-wrap gap-2 font-bold">
              Tili: <p className="font-normal capitalize">{kino.tili}</p>
            </span>
            <span className="flex flex-wrap gap-2 font-bold">
              Davlati:
              <p className="font-normal capitalize">{kino.davlati}</p>
            </span>
            <span className="flex flex-wrap gap-2 font-bold">
              Yili: <p className="font-normal capitalize">{kino.yili}</p>
            </span>
            <span className="flex flex-wrap gap-2 font-bold">
              Davomiyligi:
              <p className="font-normal capitalize">{kino.davomiyligi}</p>
            </span>
          </div>
